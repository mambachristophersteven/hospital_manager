...
// $resultclasses= mysqli_query($con, $sqlclasses);
        ...
        <main>
            ...
            <div class="insights">
                ...
                <div class="non-teaching-population">
                    ...
                    <div class="middle">
                        <div class="left">
                            <h2>Access all data from doctors list</h2>
                            <h1>Review Info</h1>
                        </div>
                    </div>
                ...
                <div class="student-population">
                    ...
                    <div class="middle">
                        <div class="left">
                            <h2>This page gives the full list of doctors with related info</h2>
                            <h1></h1>
                        </div>
                        <div class="progress">
                            <svg>
                    ...
                    <small class="text-muted">search through records of doctors</small>
                </div>
                <!-- end of doctor population -->               
            </div>
            <!-- end of insights -->
            <div class="recent">
                <div class="search">
                    <form class="search_box" action="./searchdoctordeveloper.php" method="get" >
                        <input type="text" name="search" id="" placeholder="search doctor" value="<?php echo $search;?>">
                        <br>
                ...
                <button id="add-new-applicant" onclick="location.href='./addnewdoctordeveloper.php'">Add New Doctor</button>
                <table>
                    <thead>
                        <tr>
                            <th>Name</th>
                    ...
                    <tbody>
                        ...
                        include '../connection.php';
                        $sqldisplay= "SELECT * FROM `doctors` WHERE firstname LIKE '%$search%' OR lastname LIKE '%$search%' OR department LIKE '%$search%' OR othername LIKE '%$search%'";
