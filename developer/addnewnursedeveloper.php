                                                            ...
                                                            if(empty($religion)){
                                                                ...
                                                                if($imagefilesize===0){
                                                                    ...
                                                                    if(in_array($imagefilenameextension,$extensions)){
                                                                        ...
                                                                        $sqlinsert= "INSERT INTO `nurses` (firstname,lastname,age,gender,marital_status,image,date_of_birth,address,gps_address,landmark,hometown,telephone1,telephone2,religion,spouse_firstname,spouse_lastname,spouse_telephone,date_of_employment,added_by,email,date_added,othername) VALUES ('$firstname','$lastname','$age','$gender','$marital_status','$upload_image','$date_of_birth','$address','$gps_address','$landmark','$hometown','$telephone1','$telephone2','$religion','$spouse_firstname','$spouse_lastname','$spouse_telephone','$date_of_employment','$admin_fullname','$email','$date_added','$othername')";
    ...
    <div class="container">
        ...
        <main>
            ...
            <div class="form-format">              
                <div class="form">
                    <form action="./addnewnursedeveloper.php" method="post" enctype="multipart/form-data" id="form">
