...
<body onload="initClock()">
    <div class="container">
        ...
        <main>
            ...
            <div class="recent">
                 <div class="search">
                    <form class="search_box"action="./searchpatientdeveloper.php" method="get">
                ...
                <h2>All Patients</h2>
                <button id="add-new-applicant" onclick="location.href='./addnewpatientdeveloper.php'">Add New Patient</button>
                <table>
                    <thead>
                        <tr>
                            <th>Name</th>
