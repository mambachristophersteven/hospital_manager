...
$numdoctors=mysqli_num_rows($resultdoctors); 
...
$resultnurses= mysqli_query($con, $sqlnurses);
$numnurses=mysqli_num_rows($resultnurses); 

$total_population= $numadmins + $numdoctors + $numnurses + $numpatients;
...
<body onload="initClock()">
    <div class="container">
        <aside>
            ...
            <div class="sidebar">
                <a href="./overviewdeveloper.php" class="active">
        ...
        <main>
            ...
            <div class="insights">
                <div class="student-population">
                    ...
                    <small class="text-muted">total number of people with the hospital</small>
                </div>
                ...
                <div class="teaching-population">
                    ...
                    <small class="text-muted">total number of doctors</small>
                </div>
                ...
                <div class="non-teaching-population">
                    ...
                    <small class="text-muted">total number of nurses</small>
                </div>
                <div class="non-teaching-population">
                ...
                <div class="non-teaching-population">
                    ...
                    <small class="text-muted">total number of admins</small>
                </div>
                <!-- end of student population -->               
            </div>
            <!-- end of insights -->
            <div class="recent">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        include '../connection.php';
                        $sqldisplay= "SELECT * FROM `patients` ORDER BY id DESC LIMIT 4";
                        ...
                        if($resultdisplay){
                            while($rowdisplay=mysqli_fetch_assoc($resultdisplay)){
                                ...
                                <tr>
                                    ...
                                    <td>$age</td>
                                    <td>$telephone1</td>
                                    <td><button id='view'  onclick=\"location.href = 'viewpatientdeveloper.php?viewid=".$id."'\">View</button></td>
                                </tr>
                ...
                <a href="./patientsdeveloper.php">Show All</a>
                <h2>Recently Added Nurses</h2>
                <table>
                    <thead>
                        <tr>
                            <th>Name</th>
                    ...
                    <tbody>
                        ...
                        include '../connection.php';
                        $sqldisplay= "SELECT * FROM `nurses` ORDER BY id DESC LIMIT 4";
                        $resultdisplay= mysqli_query($con, $sqldisplay);
                        if($resultdisplay){
                            while($rowdisplay=mysqli_fetch_assoc($resultdisplay)){
                                $id=$rowdisplay['id'];
                                ...
                                <tr>
                                    ...
                                    <td>$age</td>
                                    <td>$telephone1</td>
                                    <td><button id='view'  onclick=\"location.href = 'viewnursedeveloper.php?viewid=".$id."'\">View</button></td>
                                </tr>
                ...
                <a href="./nursesdeveloper.php">Show All</a>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        include '../connection.php';
                        $sqldisplay= "SELECT * FROM `doctors` ORDER BY id DESC LIMIT 4";
                        $resultdisplay= mysqli_query($con, $sqldisplay);
                        if($resultdisplay){
                            while($rowdisplay=mysqli_fetch_assoc($resultdisplay)){
                                $id=$rowdisplay['id'];
                                ...
                                $othername=" ".$rowdisplay['othername'];
                                $telephone1=$rowdisplay['telephone1'];
                                $department=$rowdisplay['department'];
                                $fullname=$firstname.$lastname.$othername;
                                ...
                                <tr>
                                    ...
                                    <td>$age</td>
                                    <td>$telephone1</td>
                                    <td><button id='view'  onclick=\"location.href = 'viewdoctordeveloper.php?viewid=".$id."'\">View</button></td>
                                </tr>
                ...
                <a href="./doctorsdeveloper.php">Show All</a>
            </div>
        </main>
        <!-- end of main -->
        <div class="right">
