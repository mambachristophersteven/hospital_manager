...
if(isset($_POST['submit'])){
    ...
    $sqlinsert= "INSERT INTO `patients` (firstname,lastname,age,gender,date_of_birth,address,gps_address,telephone1,telephone2,date_of_admission,added_by,date_added,othername,patient_id,patient_complaints) VALUES ('$firstname','$lastname','$age','$gender','$date_of_birth','$address','$gps_address','$telephone1','$telephone2','$date_of_admission','$admin_fullname','$date_added','$othername','$patient_id','$patient_complaints')";
    $resultin= mysqli_query($con, $sqlinsert);
    if($resultin){
        header("location: ./patientsdeveloper.php");
        exit;
    }
    else{
    ...
    <div class="container">
        <aside>
            ...
            <div class="sidebar">
                ...
                <a href="./patientsdeveloper.php" class="active">
        ...
        <main>
            ...
            <div class="form-format">              
                <div class="form">
                    <form action="./addnewpatientdeveloper.php" method="post" enctype="multipart/form-data" id="form">
                        ...
                        <div class="form-divisions">
                            ...
                            <input type="date" name="date_of_admission"  id="date_of_admission" value=<?php echo $date_of_admission;?>>
                        </div>
                        <div class="form-divisions">
                            <input type="text" name="patient_id" id="patient_id" placeholder="enter patient id" value=<?php echo $patient_id;?>>                      
                        </div>
                        <div class="form-divisions">
                            <h4 class="select-heading">patient_complaints</h4>
                            <textarea name="patient_complaints" id="patient_complaints"></textarea>
                        </div>
                    ...
                    <div class="form-divisions">
                            <button id="cancel-add" onclick="location.href='./patientsdeveloper.php'">Cancel</button>
                        </div>
                </div>
            </div>
