...
$admin_username=$rowview['username'];
$admin_position=$rowview['position'];
...
<head>
    ...
    <title>St. Andrew's Hospital - View Doctor Profile</title>
            ...
            <div class="form-format">
                <div class="form-divisions">
                    ...
                    <div class="divide"> 
                        ...
                        <div class="info-section">
                            <div class="info">
                                <p id="infos"><strong><?php echo $admin_position;?></strong></p>
                                <p>position</p>
                            </div>                          
                        </div>            
                        <div class="info-section">
                            <div class="info">
                                <p id="infos"><strong><?php echo $admin_username;?></strong></p>
                                <p>username</p>
                            </div>                          
                        </div>   
                        <div class="info-section">
                    ...
                    <div class="buttons">
                        <button id="move-new-applicant" onclick="location.href='./editdoctordeveloper.php?editid=<?php echo $id?>'">Edit Record</button>
                        <br>
                        <button id="delete-new-applicant" onclick="location.href='./deletedoctordeveloper.php?deleteid=<?php echo $id?>'">Delete Record</button>
