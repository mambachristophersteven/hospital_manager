        ...
        <main>
            ...
            <div class="form-format">
                <div class="form-divisions">                
                    ...
                    <div class="buttons">
                        <button id="move-new-applicant" onclick="location.href='./editpatientdeveloper.php?editid=<?php echo $id?>'">Edit Record</button>
                        <br>
                        <button id="delete-new-applicant" onclick="location.href='./deletepatientdeveloper.php?deleteid=<?php echo $id?>'">Delete Record</button>
