...
if(isset($_POST['submit'])){
    ...
    if(empty($firstname)){
        $error="Enter the firstname of the doctor";
    }
    else{
        if(empty($lastname)){
            $error="Enter the lastname of the doctor";
        }
        else{
            if(empty($age)){
                $error="Enter the age of the doctor";
            }
            else{
                if(empty($marital_status)){
                    $error="Select the marital status of the doctor";
                }
                else{
                    if(empty($date_of_birth)){
                        $error="Select the date of birth of the doctor";
                    }
                    else{
                        if(empty($email)){
                            $error="Enter the email address of the doctor";
                        }
                        else{
                            if(empty($address)){
                                $error="Enter the residential address of the doctor";
                            }
                            else{
                                if(empty($landmark)){
                                    ...
                                    if(empty($hometown)){
                                        $error="Enter the hometown of the doctor";
                                    }
                                    else{
                                        if(empty($telephone1)){
                                            $error="Enter the contact number of the doctor";
                                        }
                                        else{
                                            if(empty($religion)){
                                                $error="Enter the religion of the doctor";
                                            }
                                            else{
                                                if(empty($date_of_employment)){
                                                    $error="Select the date of employment";
                                                }
                                                else{
                                                    if(empty($admin_username)){
                                                        $error="Enter the username of the doctor";
                                                    }
                                                    else{
                                                        if(empty($admin_password)){
                                                            ...
                                                            if(empty($department)){
                                                                $error="Specify the department of the doctor";
                                                            }
                                                            else{
                                                                if($imagefilesize===0){
                                                                    $error="Select a picture of the doctor";
                                                                }
                                                                else{
                                                                    ...
                                                                    if(in_array($imagefilenameextension,$extensions)){
                                                                        $upload_image='../adminimages/'.$imagefilename;
                                                                        move_uploaded_file($imagefiletemp,$upload_image);
                                                                        $sqlinsert= "INSERT INTO `doctors` (firstname,lastname,age,gender,marital_status,image,date_of_birth,address,gps_address,landmark,hometown,telephone1,telephone2,religion,spouse_firstname,spouse_lastname,spouse_telephone,date_of_employment,position,added_by,email,username,password,date_added,department,othername) VALUES ('$firstname','$lastname','$age','$gender','$marital_status','$upload_image','$date_of_birth','$address','$gps_address','$landmark','$hometown','$telephone1','$telephone2','$religion','$spouse_firstname','$spouse_lastname','$spouse_telephone','$date_of_employment','$admin_position','$admin_fullname','$email','$admin_username','$admin_password','$date_added','$department','$othername')";
    ...
    <div class="container">
        ...
        <main>
            ...
            <div class="form-format">              
                <div class="form">
                    <form action="./addnewdoctordeveloper.php" method="post" enctype="multipart/form-data" id="form">
                        <h2 class="form-legend">Personal Information</h2>
                        <div class="wrapper">
                            <div class="image-container">
                                <img src="../developerimages/person.png" alt="upload image" id="person-image">
                            </div>
                            <label for="image">
                        ...
                        <div class="form-divisions">
                            ...
                            <input type="text" name="othername" id="othername" placeholder="enter any other name" value=<?php echo $othername;?>>
                        </div>
                        <div class="form-divisions">
                            <input type="email" name="email" id="email" placeholder="enter email address" value=<?php echo $email;?>>
                        </div>
                        <div class="form-divisions">
                            <input type="number" name="age" id="age" placeholder="enter age" min="1" max="80" value=<?php echo $age;?>>
                        </div>
                        <div class="form-divisions">
                            ...
                            <input type="text" name="landmark" id="landmark" placeholder="enter landmark of residence" value=<?php echo $landmark;?>>
                        </div>
                        <div class="form-divisions">
                            <input type="text" name="hometown" id="hometown" placeholder="enter hometown" value=<?php echo $hometown;?>>
                        </div>
                        <div class="form-divisions">
                            <input type="tel" name="telephone1" id="telephone1" placeholder="enter telephone number" minlength="10" maxlength="10" value=<?php echo $telephone1;?>>
                            <input type="tel" name="telephone2" id="telephone2" placeholder="enter second telephone number(optional)" minlength="10" maxlength="10" value=<?php echo $telephone2;?>>
                        </div>
                        <div class="form-divisions">
                        ...
                        <h2 class="form-legend">Employment Information</h2>
                        <div class="form-divisions">
                            <h4 class="select-heading">date of employment</h4>
                            <input type="date" name="date_of_employment"  id="date_of_employment" value=<?php echo $date_of_employment;?>>
                        </div>
                        <div class="form-divisions">
                            <h4 class="select-heading">department</h4>
                            <select name="department" id="department">
                                ...
                                <option value="Ear, Nose and Throat">Ear, Nose, Throat</option>
                                <option value="Other">Other</option>
                            </select>
                        </div>
                        <h2 class="form-legend">System Access Information</h2>
                        <div class="form-divisions">
                            <input type="text" name="admin_username" id="username" placeholder="enter system username" value= <?php echo $admin_username;?>>
                        </div>
                        <div class="form-divisions">
                            <input type="text" name="admin_password" id="password" placeholder="enter password" value= <?php echo $admin_password;?>>
                        </div>
                    ...
                    <div class="form-divisions">
                            <button id="cancel-add" onclick="location.href='./overviewdeveloper.php'">Cancel</button>
                        </div>
                </div>
            </div>
    ...
    <script>
        ...
        function checkInputs(){
            ...
            if(departmentValue === ''){
                //show error
                //add error class
                setErrorFor(department, 'Enter department of doctor');
            }
            else{
                //add success class
            ...
            if(religionValue === ''){
                //show error
                //add error class
                setErrorFor(religion, 'Enter religion of doctor');
            }
            else{
                //add success class
            ...
            if(maritalStatusValue === ''){
                //show error
                //add error class
                setErrorFor(maritalStatus, 'Enter marital status of doctor');
            }
            else{
                //add success class
            ...
            if(hometownValue === ''){
                //show error
                //add error class
                setErrorFor(hometown, 'Enter hometown of doctor');
            }
            else{
                //add success class
            ...
            if(landmarkValue === ''){
                //show error
                //add error class
                setErrorFor(landmark, 'Enter landmark of doctor residence');
            }
            else{
                //add success class
            ...
            if(dateOfEmploymentValue === ''){
                //show error
                //add error class
                setErrorFor(date_of_employment, 'Select the date doctor was employed');
            }
            else{
                //add success class
            ...
            if(genderValue === ''){
                //show error
                //add error class
                setErrorFor(gender, 'Select gender of doctor');
            }
            else{
                //add success class
            ...
            if(dateOfBirthValue === ''){
                //show error
                //add error class
                setErrorFor(date_of_birth, 'Select the date of birth of doctor');
            }
            else{
                //add success class
            ...
            if(usernameValue === ''){
                //show error
                //add error class
                setErrorFor(username, 'Enter system doctor username');
            }
            else{
                //add success class
            ...
            if(passwordValue === ''){
                //show error
                //add error class
                setErrorFor(password, 'Enter system doctor password');
            }
            else{
                //add success class
            ...
            if(ageValue === ''){
                //show error
                //add error class
                setErrorFor(age, 'Enter age of doctor');
            }
            else{
                //add success class
                setSuccessFor(age);
            ...
            if(lastnameValue === ''){
                //show error
                //add error class
                setErrorFor(lastname, 'Enter last name of doctor');
            }
            else{
                //add success class
            ...
            if(firstnameValue === ''){
                //show error
                //add error class
                setErrorFor(firstname, 'Enter first name of doctor');
            }
            else{
                //add success class
            ...
            if(imageInput.value===''){
                ...
                errorMessage.innerText = "Select a picture of the doctor";
            }
            else{
                imageContainer.style.border = "3px solid #7380ec";
            }

            if(firstnameValue !='' && lastnameValue !='' && ageValue !='' && emailValue !='' && addressValue !='' && genderValue !='' && landmarkValue !='' && hometownValue !='' && religionValue !='' && telephone1Value !='' && imageInput.value !='' && dateOfEmploymentValue !=''  && dateOfBirthValue !='' && usernameValue !='' && passwordValue !='' && departmentValue !=''){
