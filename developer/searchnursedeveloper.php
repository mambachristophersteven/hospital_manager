        ...
        <main>
            ...
            <div class="insights">
                ...
                <div class="non-teaching-population">
                    ...
                    <div class="middle">
                        <div class="left">
                            <h2>Access all data from nurses list</h2>
                            <h1>Review Info</h1>
                        </div>
                    </div>
                ...
                <div class="student-population">
                    ...
                    <div class="middle">
                        <div class="left">
                            <h2>This page gives the full list of nurses with related info</h2>
                            <h1></h1>
                        </div>
                        <div class="progress">
                            <svg>
                    ...
                    <small class="text-muted">search through records of nurses</small>
                </div>
            ...
            <div class="recent">
                <div class="search">
                    <form class="search_box" action="./searchnursedeveloper.php" method="get" >
                        <input type="text" name="search" id="" placeholder="search nurse" value="<?php echo $search;?>">
                        <br>
                ...
                <button id="add-new-applicant" onclick="location.href='./addnewnursedeveloper.php'">Add New Nurse</button>
                <table>
                    <thead>
                        <tr>
                            <th>Name</th>
                    ...
                    <tbody>
                        ...
                        include '../connection.php';
                        $sqldisplay= "SELECT * FROM `nurses` WHERE firstname LIKE '%$search%' OR lastname LIKE '%$search%' OR othername LIKE '%$search%'";
