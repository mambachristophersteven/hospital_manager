            ...
            if($nums>0){
                ...
                if($passwordinDb===$password){
                    if($position==="Receptionist"){
                        ...
                        header('location: ./receptionist/overviewreceptionist.php');
                    }
                }
                else{
                    $error= "Invalid Login Credentials";
...
<head>
    ...
    <title>St. Andrew's Hospital - Receptionist Login Page</title>
...
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <form action="./receptionistlogin.php" method="post" id="form">
