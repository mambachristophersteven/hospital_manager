...
<head>
    ...
    <title>St.Andrew's - Receptionist</title>
...
<body onload="initClock()">
    <div class="container">
        <aside>
            ...
            <div class="sidebar">
                <a href="./overviewreceptionist.php" class="active">
                ...
                <a href="./patientsreceptionist.php">
        ...
        <main>
            ...
            <div class="recent">
                ...
                <a href="./patientsreceptionist.php">Show All</a>
            </div>
        </main>
        <!-- end of main -->
        <div class="right">
