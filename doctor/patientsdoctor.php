...
<head>
    ...
    <title>St.Andrew's - Doctor</title>
...
<body onload="initClock()">
    <div class="container">
        ...
        <main>
            ...
            <div class="recent">
                 <div class="search">
                    <form class="search_box"action="./searchpatientdoctor.php" method="get">
                        ...
                        if($resultdisplay){
                            while($rowdisplay=mysqli_fetch_assoc($resultdisplay)){
                                ...
                                <tr>
                                    ...
                                    <td>$age</td>
                                    <td>$telephone1</td>
                                    <td><button id='view'  onclick=\"location.href = 'viewpatientdoctor.php?viewid=".$id."'\">View</button></td>
                                </tr>
