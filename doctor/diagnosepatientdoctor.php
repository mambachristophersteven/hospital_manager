...
if(isset($_POST['submit'])){
    $doctor_patient_complaints=$_POST['doctor_patient_complaints'];
    $doctor_diagnosis=$_POST['doctor_diagnosis'];
    $doctor_prescription=$_POST['doctor_prescription'];
    $doctor_recommendation=$_POST['doctor_recommendation'];
    $next_appointment_date=$_POST['next_appointment_date'];
    $diagnosis_date_added= date('Y-m-d'); 

    $sqlinsert= "UPDATE `patients` SET id ='$id',doctor_patient_complaints='$doctor_patient_complaints',doctor_diagnosis='$doctor_diagnosis',doctor_prescription='$doctor_prescription',doctor_recommendation='$doctor_recommendation',next_appointment_date='$next_appointment_date',diagnosis_date_added='$diagnosis_date_added',diagnosed_by='$admin_fullname' WHERE id ='$id'";
...
<head>
    ...
    <title>St. Andrew's - Add New Patient</title>
...
<body onload="initClock()"> 
    <div class="container">
        <aside>
            ...
            <div class="sidebar">
                <a href="./patientsdoctor.php" class="active">
        ...
        <main>
            ...
            <h2>Enter Patient's Diagnosis</h2>
            <h2 id="success-msg"><?php echo $success; ?></h2>
            <div class="form-format">              
                <div class="form">
                    <form action="" method="post" enctype="multipart/form-data" id="form">
                        <h2 class="form-legend">Diagnostic Information</h2>
                        <h2 class="form-legend">Admission Information</h2>
                        <div class="form-divisions">
                            <h4 class="select-heading">patient complaints</h4>
                            <textarea name="doctor_patient_complaints" id="doctor_patient_complaints" value=<?php echo $doctor_patient_complaints;?>></textarea>
                        </div>
                        <div class="form-divisions">
                            <h4 class="select-heading">doctor's diagnosis</h4>
                            <textarea name="doctor_diagnosis" id="doctor_diagnosis" value=<?php echo $doctor_diagnosis?>></textarea>
                        </div>
                        <div class="form-divisions">
                            <h4 class="select-heading">doctor's presciption</h4>
                            <textarea name="doctor_prescription" id="doctor_prescription" value=<?php echo $doctor_prescription;?>></textarea>
                        </div>
                        <div class="form-divisions">
                            <h4 class="select-heading">next appointment date</h4>
                            <input type="date" name="next_appointment_date"  id="next_appointment_date" value=<?php echo $next_appointment_date;?>>
                        </div>
                        <div class="form-divisions">
                            <h4 class="select-heading">doctor's recommendation</h4>
                            <textarea name="doctor_recommendation" id="doctor_recommendation" value=<?php echo $doctor_recommendation;?>></textarea>
                        </div>
    ...
    <script>
        ...
        const doctor_diagnosis = document.getElementById('doctor_diagnosis');
        const doctor_prescription = document.getElementById('doctor_prescription');
        const patient_complaints = document.getElementById('doctor_patient_complaints');
        const doctor_recommendation = document.getElementById('doctor_recommendation');
        ...
        function checkInputs(){
            ...
            const nextAppointmentValue = next_appointment_date.value.trim();
            const doctorDiagnosisValue = doctor_diagnosis.value.trim();
            const doctorPrescriptionValue = doctor_prescription.value.trim();
            const doctorRecommendationValue = doctor_recommendation.value.trim();
            ...
            if(nextAppointmentValue === ''){
                //show error
                //add error class
                setErrorFor(next_appointment_date, 'Enter next appointment date for patient');
            }
            else{
                //add success class
                setSuccessFor(next_appointment_date);
            }
            if(doctorDiagnosisValue === ''){
                //show error
                //add error class
                setErrorFor(doctor_diagnosis, 'Enter your diagnosis');
            }
            else{
                //add success class
                setSuccessFor(doctor_diagnosis);
            }
            if(doctorPrescriptionValue === ''){
                //show error
                //add error class
                setErrorFor(doctor_prescription, 'Enter your presciption');
            }
            else{
                //add success class
                setSuccessFor(doctor_prescription);
            }
            if(doctorRecommendationValue === ''){
                //show error
                //add error class
                setErrorFor(doctor_recommendation, 'Enter your recommendation');
            }
            else{
                //add success class
                setSuccessFor(doctor_recommendation); 
            }

            if(patientComplaintsValue !='' && nextAppointmentValue !='' && doctorDiagnosisValue !='' && doctorPrescriptionValue !='' && doctorRecommendationValue){
