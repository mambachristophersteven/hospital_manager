...
$doctor_diagnosis=$rowview['doctor_diagnosis'];
$doctor_prescription=$rowview['doctor_prescription'];
$doctor_recommendation=$rowview['doctor_recommendation'];
$doctor_patient_complaints=$rowview['doctor_patient_complaints'];
$diagnosed_by=$rowview['diagnosed_by'];
$diagnosis_date_added=$rowview['diagnosis_date_added'];
$next_appointment_date=$rowview['next_appointment_date'];
...
<head>
    ...
    <title>St. Andrew's Hospital - View Patient Profile</title>
                ...
                <div class="form-divisions">                
                    <div class="divide"> 
                        <div class="info-section">
                            <div class="info">
                                <p id="infos"><strong><?php echo $patient_id;?></strong></p>
                                <p>patient id</p>
                            </div>                          
                        </div> 
                        <div class="info-section">
                        ...
                        <div class="info-section">
                            <div class="info">
                                <p id="infos"><strong><?php echo $patient_complaints;?></strong></p>
                                <p>patient's complaints</p>
                            </div>                          
                        </div>  
                        <div class="info-section">
                            <div class="info">
                                <p id="infos"><strong><?php echo $date_of_admission;?></strong></p>
                        ...
                        <div class="info-section">
                            <div class="info">
                                <p id="infos"><strong><?php echo $doctor_patient_complaints;?></strong></p>
                                <p>patient's complaints to doctor</p>
                            </div>                          
                        </div>
                        <div class="info-section">
                            <div class="info">
                                <p id="infos"><strong><?php echo $doctor_diagnosis;?></strong></p>
                                <p>doctor's diagnosis</p>
                            </div>                          
                        </div>     
                        <div class="info-section">
                            <div class="info">
                                <p id="infos"><strong><?php echo $doctor_prescription;?></strong></p>
                                <p>doctor's prescription</p>
                            </div>                          
                        </div>   
                        <div class="info-section">
                            <div class="info">
                                <p id="infos"><strong><?php echo $next_appointment_date;?></strong></p>
                                <p>next appointment date</p>
                            </div>                          
                        </div> 
                        <div class="info-section">
                            <div class="info">
                                <p id="infos"><strong><?php echo $diagnosed_by?></strong></p>
                                <p>diagnosed by</p>
                            </div>                          
                        </div> 
                        <div class="info-section">
                            <div class="info">
                                <p id="infos"><strong><?php echo $diagnosis_date_added?></strong></p>
                                <p>date of diagnosis</p>
                            </div>                          
                        </div>
                    </div> 
                    <div class="buttons">
                        <button id="move-new-applicant" onclick="location.href='./diagnosepatientdoctor.php?diagnosisid=<?php echo $id?>'">Diagnosis</button>
                        <br>
                        <!-- <button id="delete-new-applicant" onclick="location.href='./deletepatientreceptionist.php?deleteid=<?php echo $id?>'">Delete Record</button> -->
