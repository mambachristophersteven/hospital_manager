    ...
    <div class="container">
        ...
        <main>
            ...
            <div class="recent">
                ...
                <button id="add-new-applicant" onclick="location.href='./addnewpatientdoctor.php'">Add New Patient</button>
                <table>
                    <thead>
                        <tr>
                            <th>Name</th>
        ...
        <div class="right">
            <div class="top">
                ...
                <div class="profile" onclick="location.href='./doctorprofile.php'">
                    <div class="info">
